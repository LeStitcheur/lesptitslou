...
// Importation medias
import creche from '../assets/images/creche.jpg'
import creche2 from '../assets/images/creche2.jpg'
import creche3 from '../assets/images/creche3.jpg'
		...
		<div className='objectifs'>
			...
			<section className='part'>
				...
				<p className='text'>
					...
					afin qu’il puisse s’épanouir pleinement dans ce lieu collectif.
				</p>
				<img
					src={creche2}
			...
			<section className='part'>
				...
				<p className='text'>
					...
					permettant de grandir et de développer leurs capacités émotionnelles,
					sociales et créatives. En nous appuyant sur les forces, les intérêts
					et la curiosité de chaque enfant, nous les guidons dans
					l&apos;exploration du monde qui les entoure, ainsi que dans le
					développement de leurs capacités et de nouvelles amitiés.
				</p>
				<img
					src={creche3}

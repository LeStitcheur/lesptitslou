...
import image from './../assets/images/generate-sieste-nordique-colored.webp'
			...
			<div className='discover'>
				...
				<DiscoverPart title='A propos de nous'>
					<p>
						...
						avec amour et dévouement par Anaïs Schouver, notre gérante.
						Fusionnant sa profonde passion pour la musique avec un amour
						inconditionnel pour les enfants, elle crée un environnement où les
						mélodies et les rythmes ne servent pas seulement à divertir, mais
						aussi à nourrir l&apos;âme et à stimuler la créativité des
						tout-petits. Son engagement à partager cette harmonie s&apos;inscrit
						parfaitement dans la mission de notre établissement.
					</p>
				</DiscoverPart>
				<hr />
				<DiscoverPart title='Notre Mission'>
					<p>
						La mission de notre micro-crèche est de fournir un environnement
						chaleureux, sécuritaire et stimulant où chaque enfant reçoit des
						soins de qualité adaptés à son développement. Nous mettons un point
				...
				<DiscoverPart title='Pourquoi nous existons'>
					<p>
						...
						prise de conscience : le manque flagrant de structures
						d&apos;accueil adaptées aux besoins des enfants. Animée par une
						vision inébranlable et une détermination sans faille, Anaïs
						s&apos;est lancée dans cette aventure pour répondre à ce besoin
						essentiel. Malgré les défis et les obstacles rencontrés en cours de
						route, l&apos;équipe a su les surmonter avec brio, grâce à une
						persévérance et un engagement à toute épreuve.
					</p>
				</DiscoverPart>
				<hr />
				<DiscoverPart title='Engagez vous avec nous'>
					<p>
						Votre soutien et votre engagement sont essentiels à la poursuite de
						notre mission. Nous vous invitons à plonger dans notre histoire et à
						nous rejoindre dans cette aventure enrichissante. Vous pouvez rester
						...
						sont aussi des canaux actifs où nous partageons nos mise à jour et
